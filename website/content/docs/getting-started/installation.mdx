---
title: Installation
description: Get the openbbq command, FFmpeg, and a recognition model onto your machine.
---

OpenBBQ needs a few ingredients before it can cook. This page installs each one, then checks the kitchen.
